...
Most of these come down to network reality or how europepmc serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

europepmc rate-limits like any public site. epmc already paces
...
Where a surface is gated, epmc reads a cookie or token you supply
...
`epmc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what epmc actually did
